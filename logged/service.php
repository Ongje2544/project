...
?>
    ...
    <div style="margin-left: 18rem; margin-top: 3rem; margin-bottom: 3rem;">
        <img src="../logo/service.jpg" style="border: 15px solid #FFF; background: url(<path-to-image>), lightgray 50% / cover no-repeat; width: 1019px; height: 721px;">
    </div>
    <footer class="footer">
