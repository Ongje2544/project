        ...
        <div class="row">
            <div class="container">
                <div class="form mt-5 mb-5">
                    <form action="edit.php" method="post" id="edit" class="input-group" enctype="multipart/form-data">
                        <div class="col-sm-4 image-form">
                            ...
                            ?>
                                <div class="container">
                                    <div style="margin-top: 5.5rem; margin-bottom: 2.5rem;">
                                        <center>
                                            <img src="<?php echo $imageURL ?>" alt="" width="250px" style="object-fit: fill; border-radius: 20px;">
                                        </center>
                                    </div>
                                </div>
                                <div class="ms-4 me-4">
                                    <label class="form-label">เลือกรูปภาพ :</label>
                                    <input type="file" class="form-control" name="image" id="img" style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.30);">
                                    <input type="text" hidden="hidden" name="old_image" value="<?php echo $imagename ?>" style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.30);">
                        ...
                        <div class="col-sm-8 text-form">
                            <div class="fl">
                                <div class="f">
                                    ...
                                    <input type="text" name="fname" id="fname" class="input-field" placeholder="ชื่อ" required title="กรุณาใส่ชื่อ" value="<?php echo $fname ?>">
                                </div>
                                <div class="l">
                                    <label id="lname">นามสกุล :</label>
                                    <input type="text" name="lname" id="lname" class="input-field" placeholder="นามสกุล" required title="กรุณาใส่นามสกุล" value="<?php echo $lname ?>">
                                </div>
                            </div>
                            <div class="ue">
                                <div class="u">
                                    <label id="username">ชื่อผู้ใช้ :</label>
                                    <input type="text" name="username" class="input-field" id="username" placeholder="ชื่อผู้ใช้" required title="กรุณาใส่ชื่อผู้ใช้ (ชื่อควรเป็นภาษาอังกฤษ เช่น Porama201 เป็นต้น)" pattern="[a-zA-Z0-9]{5-255}" value="<?php echo $username ?>" readonly style="color: gray;">
                                </div>
                                <div class="e">
                                    <label id="email">อีเมล :</label>
                                    <input type="email" name="email" class="input-field" id="email" placeholder="อีเมล" required title="กรุณาใส่อีเมล" value="<?php echo $email ?>">
                                </div>
                            </div>
                            <div class="cli">
                                <div class="c">
                                    <label id="callnum">เบอร์โทรศัพท์ :</label>
                                    <input type="text" name="callnum" class="input-field" id="callnum" placeholder="เบอร์โทรศัพท์" pattern="[0-9]{10}" required title="กรุณาใส่เบอร์ที่ติดต่อได้" value="<?php echo $callnum ?>">
                                </div>
                                <div class="li">
                                    <label id="lineid">Line ID :</label>
                                    <input type="text" name="lineid" class="input-field" id="lineid" placeholder="Line ID (ถ้ามี)" title="ใส่ Line ID (ถ้ามี)" value="<?php echo $lineid ?>">
                                </div>
                            </div>
                            <div>
                                <label id="address">บ้านที่อยู่ :</label>
                            </div>
                            <textarea rows="3" type="text" name="address" class="input-field ad" id="address" placeholder="ที่อยู่" required title="กรุณาใส่ที่อยู่"><?php echo $address ?></textarea>
                            <div>
                                <label id="zip">รหัสไปรษณีย์ :</label>
                            </div>
                            <input type="zip" name="zip" class="input-field" id="zip" placeholder="รหัสไปรษณีย์" inputmode="numeric" pattern="[0-9]{5}" required title="กรุณาใส่ที่อยู่ไปรษณีย์" value="<?php echo $zip ?>">
                            <div class="mt-3">
