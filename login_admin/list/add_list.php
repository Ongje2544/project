...
$sql = "INSERT INTO list(id_list,branch_list,name_list,price_list,teach_list,concept_list) VALUES('$id_list','$branch_list','$name_list','$price_list','$teach_list','$concept_list')";
