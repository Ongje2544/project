        ...
        <div class="container pt-2">
            ...
            if ($query->num_rows > 0) {
                while ($row = $query->fetch_assoc()) {
                    $imageURL = 'login_admin/news/upload/' . $row['image_news'];
            ?>
                    <center>
                        <div class="case">
                            <div class="row">
                                <div class="col-lg-4 p-5">
                                    <img src="<?php echo $imageURL ?>" class="image" alt="" width="250" height="250">
                                </div>
                                <div class="col-lg-8 pt-4">
                                    <h3><?php echo $row['name_news']; ?></h3>
                                    <p class="text pe-5"><?php echo $row['descript_news']; ?></p>
                                </div>
                            </div>
                        </div>
                    </center>
